#--------- Flask settings
SERVER_HOST = 'https://anlt16-webappservice.azurewebsites.net/' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://anlt16function.azurewebsites.net/api/"
